...
class DfeFrame(tk.Frame): 
    ...
    def count_one(self, lam, mu, lam2=None, mu2=None):
        if lam < self.lambda_min or lam > self.lambda_max or mu < self.mu_min or mu > self.mu_max or \
           lam2 < self.lambda2_min or lam2 > self.lambda2_max or mu2 < self.mu2_min or mu2 > self.mu2_max:
